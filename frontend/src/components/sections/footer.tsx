...
export const Footer: React.FC = () => {
	return (
		<footer className="container mx-auto flex items-center justify-center bg-white rounded-lg shadow-sm mb-4">
			<div className="w-full p-12 bg-neutral-700 rounded-lg">

...
const DashboardSection: React.FC = () => {
	return (
		<div className="container mx-auto h-lvh max-h-[1100px] xs:h-[900px] flex xs:flex-col items-center justify-center gap-12 lg:gap-0 xs:gap-0 xs:mb-40 overflow-x-visible relative">
			{/* Left Column - Content */}
			...
			<div className="flex-1 xs:hidden  overflow-visible">
				<motion.img
					src="/assets/dashboard_2.webp"
					alt="Dashboard Image"
					className="xs:hidden absolute w-1/2 h-full top-1/2 -translate-y-1/2 scale-130 lg:scale-100 -right-30 lg:-right-10 object-cover object-left overflow-visible bg-transparent rounded-l-4xl"
					style={{
						maxHeight: '500px',
						boxShadow: '0 0px 33px 1px rgba(12, 12, 13, 0.15)',
					}}
